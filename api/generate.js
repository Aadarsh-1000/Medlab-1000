...
function wantsStream(req) {
  return req.headers.accept?.includes(
    "text/event-stream"
  );
}
...
function symptomNameMatchesTerm(
  name,
  term
) {
...
async function generateAnswer(
  ...
  if (
    ...
    progress.send(
      "search_started",
      "Sending DB matches to medical search"
    );
    ...
    progress.send(
      "search_done",
      "Medical search results received",
